...
> **TL;DR:** This system is designed to work with GitHub Copilot Chat custom modes, where each mode loads only the rules it needs. The system uses visual Mermaid diagrams and selective document loading to optimize context usage.

## 🧭 MODE-SPECIFIC VISUAL MAPS

```mermaid
graph TD
    subgraph Modes["GitHub Copilot Chat Custom Modes"]
...
Refer to [command-execution.mdc](mdc:.github/chatmodes/isolation_rules/Core/command-execution.mdc) for detailed guidance. 