---
description: 'PLAN MODE (Task Planning)'
...
```mermaid
graph TD
    Start["🚀 START PLANNING"] --> ReadTasks["📚 Read tasks.md<br>.github/chatmodes/isolation_rules/main.mdc"]
    
    %% Complexity Level Determination
    ReadTasks --> CheckLevel{"🧩 Determine<br>Complexity Level"}
    CheckLevel -->|"Level 2"| Level2["📝 LEVEL 2 PLANNING<br>.github/chatmodes/isolation_rules/visual-maps/plan-mode-map.mdc"]
    CheckLevel -->|"Level 3"| Level3["📋 LEVEL 3 PLANNING<br>.github/chatmodes/isolation_rules/visual-maps/plan-mode-map.mdc"]
    CheckLevel -->|"Level 4"| Level4["📊 LEVEL 4 PLANNING<br>.github/chatmodes/isolation_rules/visual-maps/plan-mode-map.mdc"]
...
```
read_file({
  target_file: ".github/chatmodes/isolation_rules/visual-maps/plan-mode-map.mdc",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/chatmodes/isolation_rules/Level2/task-tracking-basic.mdc",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/chatmodes/isolation_rules/Level3/task-tracking-intermediate.mdc",
  should_read_entire_file: true
})

read_file({
  target_file: ".github/chatmodes/isolation_rules/Level3/planning-comprehensive.mdc",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/chatmodes/isolation_rules/Level4/task-tracking-advanced.mdc",
  should_read_entire_file: true
})

read_file({
  target_file: ".github/chatmodes/isolation_rules/Level4/architectural-planning.mdc",
  should_read_entire_file: true
})
```
